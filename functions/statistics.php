...
class Zume_Statistics
{
    ...
    public function statistics() : array {
        ...
        $births_millisecond_interval = 232.55814;
        $deaths_millisecond_interval = 555.555556;
        $non_christian_population = 68.8;
        $deaths_without_christ_interval = $deaths_millisecond_interval * ( .01 * $non_christian_population );
        ...
        return [
            ...
            'counter' => [
                1 => [
                    ...
                    'deaths_without_christ_interval' => $deaths_without_christ_interval,
