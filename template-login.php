...
if ( isset( $_GET['action'] ) && 'logout' === $_GET['action'] ) {
    ...
    wp_safe_redirect( zume_home_url() );
    exit;
}
                        ...
                        <div class="grid-x grid-padding-x grid-padding-y">
                            ...
                            <div class="cell">
                                <div class="wp_lostpassword_form">
                                    <?php if ( ! $sent ) : ?>
                                    <form name="lostpasswordform" id="lostpasswordform" action="<?php echo esc_url( zume_lostpassword_url() ); ?>" method="post">
            ...
            <div id="login">
                ...
                <div id="inner-content" class="grid-x grid-margin-x grid-padding-x">
                    ...
                    <div class="cell callout medium-6 large-4">
                        <div class="grid-x grid-padding-x grid-padding-y">
                            <div class="cell center"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/images/zume-logo-white.png' ) ) ?>" /></div>
                            <div class="cell"><?php echo sprintf( 'Your password is reset. %s You can login here %', '<a href="' . esc_url( zume_login_url() ) . '">', '</a>' ) ?></div>
                        </div>
                    </div>
                    <div class="cell medium-3 large-4"></div>
                </div>
                        ...
                        <div class="grid-x grid-padding-x grid-padding-y">
                            ...
                            <div class="cell">
                                <div class="wp_resetpassword_form">
                                    <form name="resetpassform" id="resetpassform" action="<?php echo esc_url( zume_login_url() . '/?action=resetpass' ); ?>" method="post" autocomplete="off" data-abide novalidate>
                ...
                <div class="grid-x grid-padding-x">
                    ...
                    <div class="cell medium-6 large-4">
                        ...
                        <?php if ( ! isset( $_GET['checkemail'] ) || ! in_array( wp_unslash( $_GET['checkemail'] ), array( 'confirm', 'newpass' ) ) ) : ?>
                            ...
                            <a href="<?php echo esc_url( zume_register_url() ) ?>"><?php esc_html_e( 'Register', 'zume' ) ?></a>
                            &nbsp;|&nbsp;
                            <a href="<?php echo esc_url( zume_lostpassword_url() ); ?>"><?php esc_html_e( 'Lost your password?', 'zume' ); ?></a>
